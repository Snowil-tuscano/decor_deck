...
import 'package:Decor_Deck/constants.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            buildSearchForm(),
            const SizedBox(height: defaultPadding),
            Text(_showSearchResult ? "Search Results" : "Top furniture",
                ...
                itemBuilder: (context, index) => Padding(
                  ...
                  child: _isLoading
                      ...
                      : furnitureInfoBigCard(
                          ...
                          numOfRating: 200,
                          deliveryTime: 25,
                        frunit: const ["Chinese", "American", "Deshi food"],
                          press: () {},
                        ),
                ),
              ),
