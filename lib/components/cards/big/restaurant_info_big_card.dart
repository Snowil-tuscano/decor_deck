...
class furnitureInfoBigCard extends StatelessWidget {
  final List<String> images, frunit;
  final String name;
  final double rating;
    ...
    return InkWell(
      ...
      child: Column(
        ...
        children: [
          ...
          PriceRangeAndFoodtype(foodType: frunit),
          const SizedBox(height: defaultPadding / 4),
          Row(
            children: [
